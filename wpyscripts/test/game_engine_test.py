...
class GameEngineTest(unittest.TestCase):
    ...
    def test_get_sdk_version(self):
        ...
        self.assertTrue(sdk_info.sdk_version == "1.1.1", "sdkversion Error")
    ...
    def test_get_touchable_element_bound(self):
        ...
        self._start()
        scene,elements = self.engine.get_touchable_elements_bound(["LuaButton, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null","UISprite, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"])
        self._end("get_touchable_element")
        self.assertEqual(len(elements), 9)
    ...
    def test_swipe_and_press(self):
        ...
        end_x,end_y=400,500
        self.engine.swipe_and_press(start_x,start_y,end_x,end_y,100,1000)
