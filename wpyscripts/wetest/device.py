...
class Device(object):
    ...
    def get_top_package_activity(self):
        ...
        result = self.adb.cmd_wait("shell", "dumpsys", "window", "windows")
...
class NativeDevice(Device):
    ...
    def __init__(self, serial, ui_device):
        ...
        if not os.environ.get("QQNAME"):
            os.environ["QQNAME"] = "1580133462"
            os.environ["QQPWD"] = "Test@2018"
