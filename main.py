...
"""
from testcase.MyTestAPI import team_prop_join_player, device
...
def main():
    ...
    logger = manager.get_logger()
    # # 第一次拉起游戏
    # os.popen("adb shell am start -n com.tencent.tmgp.speedmobile/com.tencent.tmgp.speedmobile.speedmobile")
    # time.sleep(300)
    # os.popen("adb shell am force-stop com.tencent.tmgp.speedmobile")
    try:
        _run()
    except:
        stack = traceback.format_exc()
